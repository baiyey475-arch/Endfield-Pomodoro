...
export const Input: React.FC<React.InputHTMLAttributes<HTMLInputElement>> = (
    ...
    <div className={`relative group ${props.className ?? ""}`}>
        <input
            {...props}
            className={`bg-theme-highlight/20 border border-theme-highlight text-theme-text font-ui-mono text-ui-sm leading-ui-none px-4 h-form-control focus:outline-none focus:border-theme-primary w-full min-w-0 placeholder-theme-dim/70 transition-all duration-300`}
        />
